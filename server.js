    ...
    <body>
      <div class="container">
        ...
        <div class="status">
          ...
          Server is running and ready to serve firmware updates!
        ...
        <div class="section">
          ...
          <p>
            Your ESP8266 devices can access these URLs:
          </p>

          <div class="endpoint">
            <div>
              <a href="/version.txt" target="_blank">
                /version.txt
              </a>
          ...
          <div class="endpoint">
            <div>
              <a href="/firmware.bin" target="_blank">
                /firmware.bin
              </a>

              <div class="desc">
                Firmware binary file for ESP8266
              </div>
            </div>
          </div>
          ...
          <div class="endpoint">
            <div>
              <a href="/firmware.md5" target="_blank">
                /firmware.md5
              </a>

              <div class="desc">
                MD5 checksum for firmware verification
              </div>
            </div>
          </div>
          ...
          <div class="endpoint">
            <div>
              ...
              <div class="desc">
                JSON API with version information
              </div>
            </div>
          </div>
        ...
        <div class="section">
          ...
          <p>
            Use this URL in your ESP8266 sketch:
          </p>

          <div class="code-block">
const char* serverURL = "${baseUrl}";
const char* versionURL = "${baseUrl}/version.txt";
const char* firmwareURL = "${baseUrl}/firmware.bin";
          </div>
        ...
        <div class="footer">
          <p>
            Made with ❤️ for ESP8266 OTA Updates
          </p>
...
app.get('/firmware.bin', (req, res) => {
  ...
  if (fs.existsSync(filePath)) {
    console.log(
      `📦 Serving firmware.bin to ${req.ip}`
    );
...
app.use((req, res) => {
  res.status(404).send(`
    ...
    <p>
      The endpoint <code>${req.url}</code>
      does not exist.
    </p>
...
app.listen(PORT, () => {
  ...
  console.log(
    '  - GET /version.txt   → Firmware version'
  );

  console.log(
    '  - GET /firmware.bin  → Firmware binary'
  );

  console.log(
    '  - GET /firmware.md5  → MD5 checksum'
  );

  console.log(
    '  - GET /api/version   → JSON version info'
  );
